...
insert into categorias(nome,data_cadastro,id_sub_categoria) values
 ('fogao','2000-05-03',6),('refrigerador','2003-06-30',6),
 ('notebook','2004-08-09',7),('camiseta','2008-09-29',9),
 ('cuidado pessoal','2010-04-09',10),('cameras','2005-09-15',7),('tablets','2011-09-07',7);
...
values
(12,3,'Refrigerador ff 480l',3500,'frost free 220v',5,'2001-05-02'),
(11,3,'Fogão Facilite',1000,'4 bocas inox',10,'2005-05-09'),
(13,6,'Notebook HP200',3200,'HD750 pl video dedicada 1Gb',4,'2013-03-30'),
(7,1,'Camera ws3500',1800,'semi prof 30MP zoom 16X',30,'2010-09-05'),
(7,2,'Pendrive 16Gb',110,'Classe 10 azul',50,'2012-06-03'),
(8,5,'Arroz Cristal',14,'Agulhinha tipo a classe 1',200,'2014-05-04'),
(14,4,'camiseta polo',45,'gola polo M verde',80,'2013-06-02'),
(15,3,'Secador BR2000',145,'2000wats 220volts',100,'2013-06-05'),
(17,6,'Tablet hp1.4',1230,'10P Wi-Fi 16Gb',30,'2011-10-01');
update produtos set data_alteracao = '2014-06-05' where id_produto = 7;
update produtos set id_categoria = 16 where id_produto = 4;
